...
pub struct BufferTruncateTailMutator;

impl Mutator for BufferTruncateTailMutator {
    fn name(&self) -> &'static str {
        "buffer truncate tail mutator"
    }
    ...
    fn mutate_non_mem_inputs(
        ...
        let new_len = rng.random_range(0..input.buffer.len());
        input.buffer.truncate(new_len);
    }
